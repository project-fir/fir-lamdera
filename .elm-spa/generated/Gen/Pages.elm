...
update msg_ model_ =
    case ( msg_, model_ ) of
        ...
        ( Msg.Search msg, Model.Search params model ) ->
            pages.search.update params msg model
...
view model_ =
    case model_ of
        ...
        Model.Search params model ->
            pages.search.view params model
...
subscriptions model_ =
    case model_ of
        ...
        Model.Search params model ->
            pages.search.subscriptions params model
...
pages :
    ...
    , search : Bundle Gen.Params.Search.Params Pages.Search.Model Pages.Search.Msg
...
pages =
    ...
    , search = bundle Pages.Search.page Model.Search Msg.Search
