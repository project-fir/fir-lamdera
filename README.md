...
philosophy. If it isn't Elm we don't use it, no JS, no TS, no ports, period. I believe this will take (some) power away from highly technical non-domain experts, allowing domain experts to do their work without it being polluted by non-domain concerns (like null-pointer exceptions and dependency hell).
